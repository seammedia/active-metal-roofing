...
# Array of locations: "slug|Name|Description"
locations=(
  "frankston|Frankston|Trusted metal roofing specialists serving Frankston businesses and commercial facilities."
  "mornington-peninsula|Mornington Peninsula|Quality commercial roofing solutions across the Mornington Peninsula region."
  "dandenong|Dandenong|Reliable metal roofing services for Dandenong industrial and commercial properties."
  "pakenham|Pakenham|Professional roofing solutions for Pakenham commercial and industrial clients."
  "cranbourne|Cranbourne|Expert commercial roofing services for Cranbourne businesses and facilities."
  "berwick|Berwick|Comprehensive metal roofing solutions for Berwick commercial properties."
)

for loc in "${locations[@]}"; do
  IFS='|' read -r slug name desc <<< "$loc"
...
export const metadata: Metadata = {
  title: 'Commercial Roofing Services in ${name}',
  description: '${desc}',
};
...
EOF
  ...
  echo "Created app/${slug}/page.tsx"
done

echo "All location pages created successfully!"
