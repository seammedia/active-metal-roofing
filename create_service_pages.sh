...
services=(
  ...
  "architectural-cladding:ArchitecturalCladding"
  "industrial-roofing:IndustrialRoofing"
  "roof-inspections:RoofInspections"
  "colorbond-roof-replacement:ColorbondRoofReplacement"
  "metal-roof-replacement:MetalRoofReplacement"
  "metal-roof-restoration:MetalRoofRestoration"
)

for service in "${services[@]}"; do
  IFS=':' read -r slug componentName <<< "$service"
...
export const metadata: Metadata = {
  title: page.seo?.title || \`\${page.name} | Active Metal Roofing\`,
  description: page.seo?.description || page.intro.body[0],
  openGraph: {
    title: page.seo?.title || \`\${page.name} | Active Metal Roofing\`,
    description: page.seo?.description || page.intro.body[0],
    type: 'website',
    url: \`https://activemetalroofing.com.au/\${serviceSlug}\`,
    images: [
      {
        url: \`https://activemetalroofing.com.au\${page.heroImage}\`,
        width: 1200,
        height: 630,
        alt: \`\${page.name} in Melbourne\`,
      },
    ],
  },
};
...
export default function ${componentName}Page() {
  return (
    <>
      <ServiceHero title={\`\${page.name} in Melbourne\`} image={page.heroImage} />
      <main className="bg-white">
        ...
        <nav className="max-w-7xl mx-auto px-4 md:px-6 py-4 text-sm" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-[#7A7A7A]">
            ...
            <li>/</li>
            <li>
              <span className="text-[#7A7A7A]">Services</span>
            </li>
            <li>/</li>
            <li>
        ...
        <section className="bg-[#A4D7F4] py-8 md:py-10">
          <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
            <p className="text-2xl md:text-3xl font-bold text-[#212121] mb-4">
              Need Expert {page.name} Services?
            </p>
