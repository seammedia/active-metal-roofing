...
export const metadata: Metadata = {
  title: 'Commercial Roofing Glen Waverley | Active Metal Roofing',
  description: 'Professional metal roofing solutions for Glen Waverley businesses and commercial properties. Licensed plumbers with 22 years experience.',
};

export default function GlenWaverleyPage() {
  const locationName = 'Glen Waverley';
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {services.map((service) => (
              <Link
                key={service.slug}
                href={`/glen-waverley/${service.slug}`}
