...
export const metadata: Metadata = {
  title: 'Commercial Roofing Berwick | Active Metal Roofing',
  description: 'Professional metal roofing solutions for Berwick businesses and commercial properties. Licensed plumbers with 22 years experience.',
};
