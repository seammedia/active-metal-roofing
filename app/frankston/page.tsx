...
export const metadata: Metadata = {
  title: 'Commercial Roofing Frankston | Active Metal Roofing',
  description: 'Professional metal roofing solutions for Frankston businesses and commercial properties. Licensed plumbers with 22 years experience.',
};
