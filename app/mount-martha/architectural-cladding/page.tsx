...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: `${page.seo?.description || page.intro.body[0]} Professional service in ${locationName} and surrounding areas.`,
    type: 'website',
    url: `https://activemetalroofing.com.au/mount-martha/${serviceSlug}`,
    images: [
      {
...
export default function MountMarthaarchitecturalcladdingPage() {
  return (
    <>
      ...
      <main className="bg-white">
        ...
        <nav className="max-w-7xl mx-auto px-4 md:px-6 py-4 text-sm" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-[#7A7A7A]">
            ...
            <li>/</li>
            <li>
              <a href="/mount-martha" className="hover:text-[#006991] transition-colors">
                {locationName}
              </a>
            </li>
            <li>/</li>
