...
export const metadata: Metadata = {
  title: 'Commercial Roofing Pakenham | Active Metal Roofing',
  description: 'Professional metal roofing solutions for Pakenham businesses and commercial properties. Licensed plumbers with 22 years experience.',
};

export default function PakenhamPage() {
  const locationName = 'Pakenham';
