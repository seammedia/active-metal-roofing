...
export const metadata: Metadata = {
  title: 'Commercial Roofing Bayswater | Active Metal Roofing',
  description: 'Professional metal roofing solutions for Bayswater businesses and commercial properties. Licensed plumbers with 22 years experience.',
};

export default function BayswaterPage() {
  const locationName = 'Bayswater';
