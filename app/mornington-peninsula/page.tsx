...
export const metadata: Metadata = {
  title: 'Commercial Roofing Mornington Peninsula | Active Metal',
  description: 'Professional metal roofing solutions for Mornington Peninsula businesses and commercial properties. Licensed plumbers with 22 years experience.',
};

export default function MorningtonPeninsulaPage() {
  const locationName = 'Mornington Peninsula';
